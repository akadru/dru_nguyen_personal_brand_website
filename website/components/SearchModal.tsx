...
export function SearchTrigger({ compact = false }: { compact?: boolean }) {
  return (
    <button
      ...
      className="inline-flex h-9 items-center gap-2 rounded-full border px-2.5 text-xs font-bold uppercase md:px-3"
    ...
    >
      ...
      {!compact && (
        <span
          className="ml-1 hidden rounded px-1.5 py-0.5 text-[10px] font-bold md:ml-2 md:inline"
