...
const POSTS: Post[] = [
  ...
  { title: "What running a nightclub taught me about AI adoption", kind: "LinkedIn", pillar: "Builder", topic: "Business & Leadership", read: "4 MIN", href: "/blog" },
  { title: "EOS applied to a pre-revenue startup — the 7-component teardown", kind: "Carousel", pillar: "Thinker", topic: "Operations", read: "5 MIN", href: "/blog" },
  { title: "I quit my family's factory. My dad cried.", kind: "LinkedIn", pillar: "Human", topic: "Personal Growth", read: "3 MIN", href: "/blog" },
  { title: "The Scholarly Warrior self-check before hard conversations", kind: "Substack", pillar: "Human", topic: "Leadership", read: "7 MIN", href: "/blog" },
...
const FILTERS = ["All", "AI Operator", "Business & Leadership", "Operations", "Personal Growth", "Leadership"] as const;

export default function ReadThis() {
  const [active, setActive] = useState<(typeof FILTERS)[number]>("All");
  const items = useMemo(() => (active === "All" ? POSTS : POSTS.filter((p) => p.topic === active)), [active]);
