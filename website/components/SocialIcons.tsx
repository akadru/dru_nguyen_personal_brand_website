...
// Personal handles only. Three platforms by Dru's choice.
// LinkedIn is wired; Substack + Facebook URLs need confirmation — placeholders below.
export const SOCIAL_LINKS: SocialLink[] = [
  ...
  {
    label: "Substack",
    // TODO: confirm Dru's Substack URL — placeholder uses handle from LinkedIn
    href: "https://substack.com/@drunguyen",
    svg: (
  ...
  {
    label: "Facebook",
    // TODO: confirm Dru's Facebook profile URL
    href: "https://facebook.com/dru.nguyen",
    svg: (
