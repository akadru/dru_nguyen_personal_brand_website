// Single source of truth for the 5 v3 Holtom prompts in the Olympian post.
// Imported by both page.tsx (blog body) and prompt-pack/page.tsx (copy-paste page).
// DO NOT duplicate prompt bodies in either file — edit here and both pages update.
